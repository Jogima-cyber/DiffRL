...
def get_args(): # TODO: delve into the arguments
    custom_parameters = [
        ...
        {"name": "--cfg", "type": str, "default": "./cfg/maac/ant.yaml",
        ...
        {"name": "--logdir", "type": str, "default": "logs/tmp/maac/"},
...
if __name__ == '__main__':
    ...
    import torch
    import algorithms.maac_sapo as maac_sapo
    ...
    traj_optimizer = maac_sapo.MAAC_SAPO(cfg_train)
