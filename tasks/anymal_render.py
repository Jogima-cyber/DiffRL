...
class AnymalRender(Anymal):
    ...
    def post_physics_step(self):
        ...
        self.commands_x[:] = torch.ones_like(self.commands_x)
        self.commands_y[:] = torch.zeros_like(self.commands_y)
        self.commands_yaw[:] = torch.zeros_like(self.commands_yaw)
        print(self.commands)
